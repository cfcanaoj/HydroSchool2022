      ...
      data time / 0.0d0 /
      real(8),parameter:: timemax=0.47d0   
      real(8),parameter:: dtout=0.0235d0

      integer,parameter::ngrid=2048       ! the number of grids in the simulation box
...
contains
      ...
      do i=is,ie
         if( x1c(i) < -0.8d0 ) then 
             ...
             W(i,IDN) = 1.0 + 0.25*dsin(5.0d0*pi*x1c(i))
             W(i,IV1) = 0.0d0
             W(i,IPR) = 1.0
         endif
      enddo
