...
integer::i,j,k
     ...
     !$omp parallel do private(i,j)
      ...
      do i=is,ie
          ...
          U(IMX,i,j,k) = Q(IDN,i,j,k)*Q(IV1,i,j,k)
          U(IMY,i,j,k) = Q(IDN,i,j,k)*Q(IV2,i,j,k)
          U(IMZ,i,j,k) = Q(IDN,i,j,k)*Q(IV3,i,j,k)
...
!  stime = omp_get_wtime()
     ...
     !$omp parallel do private( i, j, inv_d )
      ...
      do i=is,ie
           ...
           Q(IV1,i,j,k) = U(IMX,i,j,k)*inv_d
           Q(IV2,i,j,k) = U(IMY,i,j,k)*inv_d
           Q(IV3,i,j,k) = U(IMZ,i,j,k)*inv_d
